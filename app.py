...
@app.get('/statistics_department')
def statistics_department():
    return render_template('statistics_department.html')


@app.get('/statistics_man')
def statistics_man():
    return render_template('statistics_man.html')


@app.get('/statistics_female')
def statistics_female():
    return render_template('statistics_female.html')
